...
public final class ScotlandYard {
	 ...
	 */
	public static final ImmutableSet<Integer> REVEAL_ROUND =
	...
	public static final ImmutableList<Boolean> STANDARD24ROUNDS = IntStream.rangeClosed(1, 24)
	...
	public interface Factory<T> {
		...
		@Nonnull
		Optional<Integer> getDetectiveLocation(Detective detective);

		@Nonnull
		Optional<Board.TicketBoard> getPlayerTickets(Piece piece);
		...
		@Nonnull
		Board.GameState advance(Move move);
	}

...
@RunWith(Parameterized.class) abstract class ParameterisedModelTestBase {
	...
	/**
	 * Creates a new {@link Move.SingleMove} of a taxi
	 *
	 * @param colour colour for the move
	 * @param source the source
	...
	/**
	 * Creates a new {@link Move.SingleMove} of a secret
	 *
	 * @param colour colour for the move
	 * @param source the source
	 * @param destination the destination
	 ...
	 */
	@Nonnull static Move.SingleMove secret(@Nonnull Piece colour, int source, int destination) {
		return new Move.SingleMove(requireNonNull(colour), source, SECRET, destination);
	}
	/**
	 * Creates a new {@link Move.SingleMove} of a bus
	 *
	 * @param colour colour for the move
	 * @param source the source
	 * @param destination the destination
	 ...
	 */
	@Nonnull static Move.SingleMove bus(@Nonnull Piece colour, int source, int destination) {
		return new Move.SingleMove(requireNonNull(colour), source, BUS, destination);
	}
	/**
	 * Creates a new {@link Move.SingleMove} of an underground
	 *
	 * @param colour colour for the move
	 * @param source the source
	 * @param destination the destination
	 ...
	 */
	@Nonnull static Move.SingleMove underground(@Nonnull Piece colour, int source, int destination) {
		return new Move.SingleMove(requireNonNull(colour), source, UNDERGROUND, destination);
	}
